    ...
    <footer className="footer">
      ...
      <div className="footer-top">
        <div className="footer-top-content">
          <h2 className="footer-cta-text">Lets Connect there</h2>
        ...
        <div className="footer-container">
          ...
          <div className="footer-column">
            <div className="footer-logo-section">
              <img src="/logo2.png" alt="Logo" className="footer-logo-img" />
            ...
            <div className="footer-social-icons">
              <a 
                href="https://www.facebook.com/moazam.shigri" 
              ...
              <a 
                href="https://www.youtube.com/@Xhigri_on_air" 
                className="social-icon" 
                aria-label="YouTube"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a 
                href="https://x.com/Moazam_Shigri" 
                className="social-icon" 
                aria-label="Twitter"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className="footer-column">
            ...
            <ul className="footer-contact">
              <li>+92 3403482190</li>
              <li>muhammadmoazzamshigri@gmail.com</li>
              <li>Moaxam.dev</li>
            </ul>
          </div>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-bottom-content">
          <p className="footer-copyright">
            Copyright© 2026 M Moazam. All Rights Reserved.
          </p>
